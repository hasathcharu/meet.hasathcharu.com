import {Formatter,Validator, ErrorHandler, Input, PasswordInput, showLoadingAnimation, showSuccessModal, removeLoadingAnimation,fadeIn, floatIn} from "./input.js";
        ...
        this.dom.addEventListener("submit",(event)=>{
            ...
            (result)=>{
                if(result=="Success"){
                    ...
                    ErrorHandler.removeCurrentMessage(submitButton);
                    removeLoadingAnimation(submitButton,submitButtonText);
                    <span class="red-message">Invalid Credentials</span>
