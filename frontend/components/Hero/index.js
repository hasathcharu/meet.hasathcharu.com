...
export default function Hero(){
    ...
    contentH2.visible.transition.delay = .8;
        ...
        <div className={styles.hero} >
            <div className={styles.heroText}>
                ...
                <motion.h2
                    ...
                    variants={contentH2}
                    animate='visible'
                >Hosted by Hasathcharu</motion.h2>
                <motion.div
                    initial='hidden'
                    variants={contentP}
                    animate='visible'
                >
                    ...
                    <p>Frequent participants of Haritha's meetings can create an account to easily join future meetings without the need for lengthy links.</p>
                    <Button 
                        text="Sign Up"
                        icon={faUserPlus}
